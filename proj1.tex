...
\begin{quotation}
    Čím více {\scriptsize{\MakeUppercase{druhů}}}, \emph{řezů}, {\scriptsize{velikostí}}, \textcolor{green}{barev} písma a jiných \texttt{efektů} použijeme, \underline{tím profesionálněji} bude {\fontfamily{pzc}\selectfont{dokument}} vypadat. Čtenář tím bude {\LARGE\textbf{vždy nadšen!}}
\end{quotation}
